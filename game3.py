...
class JogoDaSoma:
    def __init__(self, root):
        ...
        pygame.mixer.init()  # Inicializar o mixer do pygame para áudio
        self.sons = [pygame.mixer.Sound(f"{num}.m4a") for num in range(1, 11)]
    ...
    def nova_rodada(self):
        ...
        self.play_sound(num1)
        self.play_sound(num2)
